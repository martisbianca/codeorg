var OneTrustStub = function(t) {
    ...
    (m = g = g || {})[m.Days = 1] = "Days", m[m.Weeks = 7] = "Weeks", m[m.Months = 30] = "Months", m[m.Years = 365] = "Years", (m = i = i || {}).Name = "OTGPPConsent", m[m.ChunkSize = 4e3] = "ChunkSize", m.ChunkCountParam = "GPPCookiesCount", (m = a = a || {}).CPRA = "usca", m.CCPA = "usca", m.CDPA = "usva", m.USNATIONAL = "usnat", m.COLORADO = "usco", m.CTDPA = "usct", m.UCPA = "usut", m.IAB2V2 = "tcfeuv2", (m = o = o || {})[m.CPRA = 8] = "CPRA", m[m.CCPA = 8] = "CCPA", m[m.CDPA = 9] = "CDPA", m[m.USNATIONAL = 7] = "USNATIONAL", m[m.COLORADO = 10] = "COLORADO", m[m.UCPA = 11] = "UCPA", m[m.CTDPA = 12] = "CTDPA", m[m.IAB2V2 = 2] = "IAB2V2";
    var s = "geo",
        r = "otpreview",
        u = (i.Name, "PRODUCTION"),
